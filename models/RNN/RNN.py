...
class _RNN_Base(nn.Module):
    def __init__(self, cfg):
        ...
        self.dropout = nn.Dropout(self.fc_dropout) if self.fc_dropout else 1
    ...
    def forward(self, x):
        ...
        #output = output[:, -1];print(output.size())  # output from last sequence step : [batch_size x hidden_size * (1 + bidirectional)]
